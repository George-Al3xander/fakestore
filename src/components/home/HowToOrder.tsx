import {BsFillPersonVcardFill, BsHandbag, BsWallet2, BsFillClipboard2CheckFill} from "react-icons/bs"
...
const HowToOrder = () => {
    ...
    return(<div className={`px-[10%] py-[5rem] bg-black text-white text-center`}>
        <div  className="mb-20">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
            <li className="flex flex-col gap-10 relative">                
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <h4 className="text-sm italic opacity-50  uppercase">temporary unavailable</h4>
                    </div>                
            ...
            <li className="flex flex-col gap-10 relative">
                    ...
                    <div className="flex flex-col gap-5">
                        <BsFillClipboard2CheckFill size={100} className="mx-auto"/>
